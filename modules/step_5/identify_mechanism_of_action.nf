...
process trigger_step_5_identify_mechanism_of_action_finemapping {
    ...
    cloudos job run \
        ...
        --job-name "${params.step_5_identify_mechanism_of_action_finemapping_cloudos_job_name}" \
...
process trigger_step_5_identify_mechanism_of_action_cheers {
    ...
    cloudos job run \
        ...
        --job-name "${params.step_5_identify_mechanism_of_action_cheers_cloudos_job_name}" \
