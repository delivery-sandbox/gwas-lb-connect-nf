...
if(params.genotype_files_list){
  Channel
    .fromPath(params.genotype_files_list)
    .set { ch_genotype_files_list_stream }
}
...
if(!!params.genotypic_linking_table){
  process add_linkage {
    publishDir "${params.outdir}/phenofile", mode: "copy"
    publishDir "s3://lifebit-user-data-etl-omop/${params.environment}/linking-tables/genotypic_linking_table.csv", mode: "copy"
    publishDir "s3://lifebit-user-data-etl-omop/${params.environment}/linking-tables/genotype_files_list.csv", mode: "copy"
    ...
    each file(genotype_files_list_stream) from ch_genotype_files_list_stream
    ...
    cp $linkage_file genotypic_linking_table.csv
