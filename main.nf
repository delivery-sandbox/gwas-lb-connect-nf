...
if (params.debug) {
    ...
    summary['step_1a_identify_genetic_associations_phenofile_database_host'] = params.step_1a_identify_genetic_associations_phenofile_database_host
    summary['step_1a_identify_genetic_associations_phenofile_database_port'] = params.step_1a_identify_genetic_associations_phenofile_database_port
    summary['step_1a_identify_genetic_associations_phenofile_database_username'] = params.step_1a_identify_genetic_associations_phenofile_database_username
    ...
    summary['step_1a_identify_genetic_associations_phenofile_database_cohort_schema'] = params.step_1a_identify_genetic_associations_phenofile_database_cohort_schema
    summary['step_1a_identify_genetic_associations_phenofile_database_dbms'] = params.step_1a_identify_genetic_associations_phenofile_database_dbms
    summary['step_1a_identify_genetic_associations_phenofile_database_name'] = params.step_1a_identify_genetic_associations_phenofile_database_name
